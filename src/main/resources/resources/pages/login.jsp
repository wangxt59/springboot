            ...
            <div class="container">
                <div class="row">                   
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <form action="/login/workLogin.action" class="form"   name="theForm"  method="post">
                            ...
                            <div style="text-align:center;">
                                ...
                                <div class="content">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="login_name" name="login_name"  title="输入账号" maxlength="20" placeholder="用户名" class="form-control"/>
