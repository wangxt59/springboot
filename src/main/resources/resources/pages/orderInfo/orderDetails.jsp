									...
									<div class="content">
										...
										<div>
											<div class="form-group">
												...
												<label class="col-sm-2 control-label">
												交易流水号：&nbsp;&nbsp;&nbsp;<c:out value="${data.trade_no}" /></label>
												<label class="col-sm-2 control-label">
												订单编号：&nbsp;&nbsp;&nbsp;<c:out value="${data.order_code}" /></label>
												<label class="col-sm-2 control-label">
											...
											<div style="margin-left:3.5%;margin-top:20px">购买商品</div>
												...
												<tbody>
													<c:forEach items="${data.list}" varStatus="item" var="m">
														<tr>
															...
															<td class="tcenter text-center" style="width:150px"><c:out value="${m.region_price}" /></td>
										...
										<div style="width:200px;margin-left:80%">
											<label class=" control-label">
											运费： &nbsp;&nbsp;&nbsp;<c:out value="${data.delivery_fee}" />元</label>
											<label class="control-label ">
											实付金额： &nbsp;&nbsp;&nbsp;<c:out value="${data.order_total}" />元
											</label>
										</div>	
