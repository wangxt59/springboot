									...
									<div class="content">
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="team_name" name="team_name" placeholder="商品名称最多输入20个字" required>
												</div>
										...
										<!-- 多图 -->
										<!-- <fieldset>
											<div class="col-sm-6 form-group first" id="images">
												<div class="" style="width: 1000px">
													...
													<div id="tu">
														<div class="form-group  " id="pic0">
															<input data-options="prompt:'Choose a file...'" type="file" id='imgs0'
																...
																<input id="pic_url0" type="hidden" name="teamPics[0].picUrl" />
															<img src="" id="pic_urla0" />
															<div id="pic_div0" style="display: block;">
																<input id="isHome0" name="teamPics[0].isHome"
																	type="hidden" value="0" /> 
													...
													<div>
														<button type="button" class="btn btn-info btn-fill btn-wd"
															onclick="closeImgsDiv();" style="margin-bottom: 10px;"
															id="">关闭</button>
													</div>
												</div>
											</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-md-3">
												<div class="form-group">
												<input type="text" value="" id="startTime" name="startTime" placeholder="开团开始时间" class="form-control" onclick= "WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"  
												 />
												</div>
												</div>
												<div class="col-md-3" >
													<div class="form-group">
													<input type="text" value="" id="endTime" name="endTime" placeholder="开团结束时间" class="form-control" onclick= "WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"  
													  />
													</div>
												</div>
											</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="checkbox" id="logistics_type" value="1"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="contact" name="contact" placeholder="请输入客服电话" required>
												</div>
											...
											<div>
												<div class="card margintop20">
													<table class="table">
														...
														<input type="hidden" id="goodsStr" name="goodsStr"
															value="" />
													</table>
												</div>
		...
		function queren() {
			...
			for (var i = 0; i < rows.length; i++) {
				if (rows[i].cells[0].childNodes[0].checked) {
					var map = {};
					map.goods_id = rows[i].cells[1].innerHTML;
