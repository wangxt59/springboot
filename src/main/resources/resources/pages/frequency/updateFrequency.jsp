...
<body>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<form class="form-horizontal" id="updateFrequencyFrom"
									action="/frequency/updateFrequency.do" name="updateFrequencyFrom"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input class="form-control" id="name" name="name" value='${map.info.name}' placeholder="名称 :" required>
												</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input id="picUrl" type="hidden" name="picUrl" value="${map.info.picUrl}"/>
													<img src="${map.info.picUrl}" id="picUrla" style="width:100px" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<select class="form-control" id="isHomeShow" name="isHomeShow">
												    	<option value="1" ${map.info.isHomeShow ==1?'selected':''}><spring:message code="language.display" /></option>
														<option value="0" ${map.info.isHomeShow ==0?'selected':''}><spring:message code="language.noDisplay" /></option>
													</select>
												</div>
										 ...
										 <fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6" style="margin-top:9px">
													<input type="radio" value="2" ${map.info.relationType ==2?'checked':''} onclick="showCategorys();" id="relationType" name="relationType"/><spring:message code="language.relationCategory" />
													<input type="radio" value="1" ${map.info.relationType ==1?'checked':''} id="relationType" onclick="showGoods();" name="relationType"/><spring:message code="language.relationGoods" />
												 </div>
											<span id="isHomeMSG" style="color: red"></span>
											</div>
										</fieldset>
										
									 <fieldset id="showCategorysDiv" style="display:${map.info.relationType ==2?'block':'none'}">
		                                  <div class="form-group">
		                                      <label class="col-sm-2 control-label"><spring:message code="language.selectCategory" />:</label>
		                                      <div class="col-sm-6">
		                                      		<div  class="list-border" id="categorys">
		                                      		 <c:forEach items="${map.frequencyCategoryRelationList}" var="rgl">
					                                         	<span>${rgl.category_name}</span>&nbsp;&nbsp;
							                             </c:forEach>
		                                      		</div>
		                                      </div>
		                              ...
		                              <input type="hidden" name="recgCategoryIds" id="recgCategoryIds" value="${map.info.recgCategoryIds}"/>
 
                                    <fieldset id="showGoodsDiv" style="display:${map.info.relationType ==1?'block':'none'}">
		                                  <div class="form-group">
		                                      <label class="col-sm-2 control-label"><spring:message code="language.relateRecommendGoods" />:</label>
		                                      <div class="col-sm-6">
		                                      		<div  class="list-border" id="goods">
		                                      		 <c:forEach items="${map.frequencyGoodsRelationList}" var="fgrl">
					                                         	<span>${fgrl.goods_name}</span>&nbsp;&nbsp;
							                             </c:forEach>
		                                      		</div>
		                                      </div>
									    ...
									    <input type="hidden" name="recgGoodsIds" id="recgGoodsIds" value="${map.info.recgGoodsIds}"/>
	...
	<script type="text/javascript">
		function checkInfo() {
			...
			$.ajax({
				url : "/frequency/updateFrequency.do",
				data :  $("#updateFrequencyFrom").serialize(),
				type : "post",
