...
<!-- 直接跳转 -->
共${pageInfo.totalPage}页 &nbsp;&nbsp;&nbsp;向<input type="text" id="pageNum" style="width: 30px" value=""/>页 <input type="button" value="跳转" onclick="gotoPage();" />

<!-- 封装并传递分页参数 -->
<input type="hidden" id="currentPage" name="pageInfo.currentPage" value=null />
