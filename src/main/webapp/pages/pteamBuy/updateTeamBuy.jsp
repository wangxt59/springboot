							...
							<div class="col-md-12">
								<div class="card">
									<div class="content">
										...
										<!-- <fieldset>
											<div class="col-sm-6 form-group first">
												<label class="col-sm-2 control-label"> 团购信息复制：</label> <input
													class="form-control" value="" id="team_code"
													name="team_code" placeholder="请输入需要复制的团购编码">
													<button type="button" class="btn btn-info btn-fill btn-wd"
														id="doSubmit" onclick="checkInfo();">复制团购</button>
											</div>
										</fieldset> -->
										<!-- *团购名称 -->
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="team_name" name="team_name" placeholder="商品名称最多输入20个字" required value="${map.platTeam.teamName}">
													<input class="form-control" id="pteamId" name="pteamId" type="text" value="${map.platTeam.pteamId}">
												</div>
										...
										<fieldset>
											<div class="form-group">
												<label class="col-sm-2 control-label"><star>*</star>团购详情:</label>
												<div class="col-sm-6">
													<button type="button" class="btn btn-round btn-wd"
													style="descWords" onclick="getWords();">+文字</button>
												<button type="button" class="btn btn-round btn-wd"
													id="descImage">+图片</button>
												<button type="button" class="btn btn-round btn-wd"
													id="descImages">+多图</button>
												<button type="button" class="btn btn-round btn-wd"
													id="descVideo">+视频</button>
												</div>
												<span id="teamNameMsg" style="color: red"></span>
											</div>
										</fieldset>
											...
											<div class="form-group" id="image">
												...
												<div class="col-sm-3">
													<input data-options="prompt:'Choose a file...'" type="file"
														id='file' name="file" onchange="getImage('file',4)"/> 
													<input id="imgUrl" type="hidden" name="imgUrl" /> 
													<img src=""	id="imgUrla" style="width: 100px;"/>
												</div>
												<div class="col-sm-3">
													<button class="btn btn-round btn-sm btn-fill" onclick="closeImgDiv();">
										...
										<fieldset>
											<div class="form-group" id="images">
												<label class="col-sm-2 control-label"><star>*</star>多图:</label>
												<div class="col-sm-3" id="pic0">
												
													 <input data-options="prompt:'Choose a file...'" type="file" id='imgs0'
																name="imgs" onchange="getImages('imgs0',0)" /> 
												</div>
												<div class="col-sm-3">
													<button class="btn btn-round btn-sm btn-fill" onclick="closeImgsDiv();">
														<span class="btn-label">
	                                                		<i class="fa fa-times"></i>
	                                            		</span>
													</button>
										...
										<!-- 视频 -->
										<fieldset>
											<div class="form-group" id="videoFile">
												<label class="col-sm-2 control-label"><star>*</star>视频:</label>
												<div class="col-sm-3">
													 <input data-options="prompt:'Choose a file...'" type="file" id='video'
														name="video" onchange="getVideo('video',3)" />
														 <input id="videoUrl" type="hidden" name="videoUrl" /> 
														 <img src="" id="videoUrla"/>
												</div>
												<div class="col-sm-3">
													<button class="btn btn-round btn-sm btn-fill" onclick="closeVideoDiv();">
														<span class="btn-label">
	                                                		<i class="fa fa-times"></i>
	                                            		</span>
													</button>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-md-3">
												<div class="form-group">
												<input type="text" value="<fmt:formatDate value="${map.platTeam.startTime}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>"  id="startTime" name="startTime" placeholder="开团开始时间" class="form-control" onclick= "WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"  
												 />
												</div>
												</div>
												<div class="col-md-3" >
													<div class="form-group">
													<input type="text" value="<fmt:formatDate value="${map.platTeam.endTime}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>" id="endTime" name="endTime" placeholder="开团结束时间" class="form-control" onclick= "WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"  
													  />
													</div>
												</div>
											</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="checkbox" id="logistics_type" value="1" ${map.platTeam.logisticsType == 1?'checked':''}
														name="logistics_type" />团长自提
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
													<input type="checkbox" ${map.platTeam.logisticsType == 2?'checked':''}
														id="logistics_type" value="2" name="logistics_type" />平台配送
												</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="contact" name="contact" placeholder="请输入客服电话" required value="${map.platTeam.contact}">
												</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<button type="button" class="btn btn-round btn-wd"
														onclick="getProvinces();" style="margin-bottom: 10px;"
														id="cityModal">选择城市</button>
												
													<label class=" control-label">已选城市:</label>
													<ul id="citysList">
														<c:forEach items="${map.regionList}" varStatus="item" var="region">
														
														<script type="text/javascript">
															cityNames.push('${region.region_name}');
															cityIds.push(${region.region_id});
														</script>
														
															<li class='provincesList' >
															<button class='btn btn-round btn-wd' >${region.region_name}</button>
															<a><i class ="pe-7s-close-circle" onclick ="removeCity(${region.region_id},'${region.region_name}')"></i></a>
															</li>
										...
										<fieldset>
											<div class="form-group">
												...
												<div style="margin-left: 3%">
													<button type="button" class="btn btn-info btn-fill btn-wd"
														id="goodModal" onclick="getGoods();">从商品库选择</button>
												</div>
											</div>
										</fieldset>
										<fieldset>
									...
									<div class="footer text-center">
										<button type="button" class="btn btn-info btn-fill btn-wd"
											id="doSubmit" onclick="savePlat()">确定</button>
