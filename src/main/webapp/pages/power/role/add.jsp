...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="/role/addRole.do" name="form1" method="post">
                          <div class="content">
                              <legend><spring:message code="language.addrole" /></legend>
                              <fieldset>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label"><star>*</star><spring:message code="language.rolename" /></label>
                                      <div class="col-sm-6">
                                          <input class="form-control" type="text" id="role_name" name="role_name" value="${roleInfo.role_name}" required>
                                      </div>
                                      <span id="role_nameMsg" style="color: red"></span>
                                  </div>
                              </fieldset>
                              <fieldset>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-6">
                                          <input class="form-control" type="text" id="discribe" name="discribe" value="${roleInfo.discribe}" required />
                                      </div>
                                      <span id="discribeMsg" style="color: red"></span>
                                  </div>
                              </fieldset>
                              <fieldset>
                                  <div class="form-group">
                                     ...
                                     <div class="col-sm-10" style="margin-top: 10px">
                                          <!--<label class="checkbox checkbox-inline">
                                              ...
                                              <input type="checkbox" data-toggle="checkbox" name="status_flg" value="1"  ${roleInfo.status_flg ==1?'checked':'checked'}/><spring:message code="language.effective" />
                                          </label>
                                          <label class="checkbox checkbox-inline">
                                              <span class="icons"><span class="first-icon fa fa-square-o"></span><span class="second-icon fa fa-check-square-o"></span></span>
                                              <input type="checkbox" data-toggle="checkbox" name="status_flg" value="0"  ${roleInfo.status_flg ==0?'checked':''}/><spring:message code="language.noeffective" />
                                          </label>-->
                                        <label>
