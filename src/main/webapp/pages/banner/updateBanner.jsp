...
<title>修改banner</title> <script language='javascript' src="js/edit.js"></script>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<form class="form-horizontal" id="updateBannerFrom"
									action="/banner/updateBanner.do" name="updateBannerFrom"
									method="post" enctype="multipart/form-data">
									<div class="content">
										<legend><spring:message code="language.bannerEdit"/></legend>
										<!-- 1.名称 -->
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<select class="form-control" id="position" name="position">
														 <c:if test="${map.info.position == '1'}">
															 <option value="1" selected="selected"><spring:message code="language.homePage"/></option>
														</c:if>
													 </select>
												</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input id="imgUrl" type="hidden" name="imgUrl" value="${map.info.imgUrl}"/>
													<img src="${map.info.imgUrl}" id="imgUrla" style="width:100px" />
												</div>
									 ...
									 <!-- 4.轮播顺序 -->
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="sort"  value='${map.info.sort}' name="sort" placeholder="轮播顺序 :" required>
												</div>
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="url"  value='${map.info.url}' name="url" placeholder="链接地址 :" required>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<select class="form-control" id="isDisplay" name="isDisplay">
														<c:if test="${map.info.isDisplay == '1'}">
															<option value="1" selected="selected"><spring:message code="language.display"/></option>
															<option value="0"><spring:message code="language.noDisplay" /></option>
														</c:if>
															
													    <c:if test="${map.info.isDisplay == '0'}">
															<option value="1"><spring:message code="language.display" /></option>
															<option value="0" selected="selected"><spring:message code="language.noDisplay"/></option>
														</c:if>
													</select>
												</div>
												<span id="urlMsg" style="color: red"></span>
