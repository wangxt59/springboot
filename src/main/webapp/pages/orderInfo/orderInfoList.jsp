		...
		<div class="main-panel">
			...
			<div class="content" >
				<div class="container-fluid">
					<form action="/orderInfo/orderList.do" name="orderform"
						id="orderform" method="post" accept-charset="utf-8">
						<div class="row">
							<div class="col-md-12">
								<div class="card" id="card">
									<div class="header">
										<h4 class="title">交易订单</h4>
									</div>
									   ...
									   <div class="col-md-3" style="width:13.5%;padding:5px">
										...
										<div class="col-md-3" style="width:12%;padding:5px;" >
			                            	<div class="form-group" style="overflow:visible;">
			                                  <select   id="status" name="status"  data-title="<spring:message code="language.Orderstatus" />" class="selectpicker">
											...
											<table class="table" style="z-index:-1">
												...
												<tbody>
													<c:forEach items="${map.pageInfo.datas}" varStatus="item" var="m">
														<tr>
															<td class="tcenter text-center"><c:out value="${m.order_code}" /></td>
															<td class="tcenter text-center" style="width:150px"><c:out value="${m.team_name}" /></td>
															...
															<td class="tcenter text-center"><c:out value="${m.order_total}" /></td>
															<td class="tcenter text-center"><c:out value="${m.order_total}" /></td>
															<td class="tcenter text-center"><c:out value="${m.point_name}"/></td>
															<td class="tcenter text-center">
															 	<c:if test="${m.delivery_type=='1'}">自提</c:if>
														    	<c:if test="${m.delivery_type=='2'}">送货上门</c:if>
														    	<c:if test="${m.delivery_type=='3'}">同时支持</c:if>
															</td>
															<td class="tcenter text-center">
															<a href="javascript:orderdetails('${m.id}');" title="查看详情">查看详情</a>
															</td>
														</tr>
													</c:forEach>
												</tbody>
...
/* 		function resetInfo() {
		 ...
		 */
		 function  orderdetails(id){
			 location.href = "/orderInfo/orderDetails.do?id="+id;
		 }
	</script>
