						...
						<div class="col-md-12">
							<div class="card">
								<form class="form-horizontal" id="addBannerFrom"
									action="/notice/addNotice.do" name="addBannerFrom"
									method="post" enctype="multipart/form-data">
									<div class="content">
										<legend><spring:message code="language.noticeCreation"/></legend>
										<!-- 1.名称 -->
										<fieldset>
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input class="form-control" id="title" name="title" placeholder="名称 :" required>
												</div>
