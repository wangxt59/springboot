...
public class DeliveryPointServiceImpl implements IDeliveryPointService {
	 ...
	 * 
	 * @see
	 * com.antke.website.service.IDeliveryPointService#selectSeMePointByPages(com.
	 * antke.website.model.bean.PageInfo, java.util.Map)
	 */
	@Override
	...
	/* 
	 * 获取自提点详情
	 * @see com.antke.website.service.IDeliveryPointService#getDeliveryPoint(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/* 
	 * 审核自提点
	 * @see com.antke.website.service.IDeliveryPointService#saveReasonById(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
