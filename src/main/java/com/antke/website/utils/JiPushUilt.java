 ...
 */  
@Component  
public class JiPushUilt {  
  
    private static final Logger LOGGER = LoggerFactory.getLogger(JiPushUilt.class);  
  
    private final static String appKey = "028bd55459951da5a1c79c12";  
  
    private final static String masterSecret = "b0c861de19d5fd0c91e33c9a";  
     ...
     * @return 0推送失败，1推送成功 
     */  
    public static  int sendToAliasList(List<String> aliasList, String notification_title, String msg_title, String msg_content, Map<String, String> extrasparam) { 
        int result = 0;  
        try {  
            ...
            System.out.println(pushPayload.getSendno());
            PushResult pushResult=jPushClient.sendPush(pushPayload.toString());  
     ...
     * @return 
     */  
    private static PushPayload buildPushObject_all_aliasList_alertWithTitle(List<String> aliasList,String notification_title, String msg_title, String msg_content, Map<String, String> extrasparam) {  
    ...
    public static void main(String[] args) {
    	...
    	list.add("1531384313860");
    	Map<String, String> map = new HashMap<String, String>();
    	map.put("type", "通知");
    	int res = sendToAliasList(list, "发送测试标题", "公告", "内容1111111111111111111111111111", map);
    	if(res == 0){
