 ...
 * 
 */  
public class HtmlGenerator extends BaseAction {  
    /**
	 * 序列化
	 */
    ...
    public static void main(String[] args){  
        ...
        h.createHtmlPage("http://127.0.0.1:8081/category/selectCategoryList.do","d:/108858901111.html");  
        System.out.println("静态页面已经生成到D盘");  
