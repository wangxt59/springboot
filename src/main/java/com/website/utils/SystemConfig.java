...
public class SystemConfig {
	...
	private static final String configPath = "config/systemconfig.properties"; // 配置文件src下的路径
...
//		systemFile="D:/MyWork/workspace/WebRoot/target/classes/config/systemconfig.properties";
